        ...
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{route('admin.brand.update')}}" method="POST" enctype="multipart/form-data">
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Brand name" name="name" id="name" tabindex="0" value="{{$brand->name}}"
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Brand Slug" name="slug" id="slug" tabindex="0" value="{{$brand->slug}}"
