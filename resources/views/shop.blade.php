...
@section('content')
                            ...
                            <div class="accordion-body px-0 pb-0 pt-3 category-list">
                                <ul class="list list-inline mb-0">
                                    @foreach ($categories as $category)
                                        <li class="list-item">
                                            <span class="menu-link menu-link_us-s py-1">
                    ...
                    <div class="accordion-item mb-4 pb-3">
                        ...
                        <div id="accordion-filter-brand" class="accordion-collapse collapse show border-0"
                            ...
                            <div class="search-field multi-select accordion-body px-0 pb-0">
                                <ul class="list list-inline mb-0 brand-list" multiple name="total-numbers-list">
                                    @foreach ($brands as $brand)
                                        <li class="list-item">
                                            ...
                                            <span class="text-right">{{ $brand->products->count() }}</span>
                                        </li>
                                    @endforeach
                                </ul>
                ...
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    ...
                    <div
                        ...
                        <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0"
                            style="margin-right: 20px;" aria-label="Page Size" id="page-size" name="page-size">
    ...
    <form id="frm-filter" action="{{ route('shop.index') }}" method="get">
